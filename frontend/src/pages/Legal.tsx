...
import { FileTextOutlined, SafetyOutlined, DatabaseOutlined } from "@ant-design/icons";

export const Legal: React.FC = () => {
  const { theme } = useTheme();
  const [activeTab, setActiveTab] = useState<"legal" | "privacy" | "cookies">("legal");
  ...
  return (
    <section className="w-full space-y-8">
      ...
      {/* Tabs */}
      <div className={`rounded-xl border p-1 inline-flex gap-1 ${
        theme === "dark"
