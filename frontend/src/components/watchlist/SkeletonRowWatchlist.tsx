  ...
  return (
    ...
    >
      ...
      <td className="px-2 sm:px-4 py-3">
        <div className="flex items-center gap-1 sm:gap-3">
          ...
          <div className="flex flex-col min-w-0 flex-1">
            <div className={`h-4 w-20 sm:w-24 rounded animate-pulse font-medium text-gray-900 dark:text-white text-sm sm:text-base ${
              theme === "dark" ? "bg-gray-700" : "bg-gray-200"
            }`} />
      ...
      <td className="px-1 sm:px-4 py-3 text-right text-gray-600 dark:text-gray-400 text-sm sm:text-base">
        <div className={`h-4 w-12 sm:w-16 rounded animate-pulse ml-auto ${
          theme === "dark" ? "bg-gray-700" : "bg-gray-200"
        }`} />
      </td>
