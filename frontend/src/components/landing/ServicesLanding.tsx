      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
         ...
         >
           <motion.h2
             ...
             className="text-4xl md:text-5xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-blue-400"
           >
